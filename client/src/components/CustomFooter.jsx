    ...
    <footer className="p-4 bg-white  shadow md:px-6 md:py-8 dark:bg-gray-900">
        <div className="sm:flex sm:items-center sm:justify-between">
            <a href="" className="flex items-center mb-4 sm:mb-0">
                ...
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Imagiinator</span>
                <h5 className='text-[15px] ml-2 dark:text-white'>Powered by</h5>
                <span className="text-white text-[18px] ml-1 "> OpenAI</span>

            </a>
            <span className="text-white">Made with <span className="text-[Red]">&#9829;</span> in India</span>
            <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                ...
                <a href="https://instagram.com/codewithmitesh?igshid=YmJhNjkzNzY=" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://twitter.com/codewithmitesh" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
                    <span className="sr-only">Twitter page</span>
                </a>
                <a href="https://github.com/codewithmitesh" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Imagiinator</a>. All Rights Reserved.
        </span>
    </footer >
